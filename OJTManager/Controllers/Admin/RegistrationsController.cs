...
namespace OJTManager.Controllers.Admin
{
    public class RegistrationsController : Controller
    {
        ...
        {
            var registrations = db.Registrations.Include(r => r.Company).Include(r => r.Evaluation).Include(r => r.Student);
        ...
        public ActionResult Create([Bind(Include = "RegistrationID,StudentID,CompanyID,Description,ProcessNote,Status,EvaluationID")] Registration registration)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "RegistrationID,StudentID,CompanyID,Description,ProcessNote,Status,EvaluationID")] Registration registration)
        {
            if (ModelState.IsValid)
            {
